...
namespace Tulsie\Bundle\PageBundle\DataFixtures\ORM;
...
class LoadPageData extends AbstractFixture implements ContainerAwareInterface, OrderedFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $this->createPlainHtmlPage($site, 'Werkgevers');
        $this->createPlainHtmlPage($site, 'Oplossingen');
        $this->createPlainHtmlPage($site, 'Issues');
        $this->createPlainHtmlPage($site, 'Over Tulsie');
        $this->createPlainHtmlPage($site, 'Icons');


        $this->createPlainHtmlPage($site, 'Algemene Voorwaarden');
        $this->createPlainHtmlPage($site, 'Betalings Voorwaarden');
        $this->createPlainHtmlPage($site, 'Werkgevers FAQ');
        $this->createPlainHtmlPage($site, 'Disclaimer');
